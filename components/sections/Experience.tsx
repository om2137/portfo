    ...
    <>  
        <div className='flex flex-col justify-center item-center mx-auto'>
            ...
            <header className=' flex item-center content-center justify-center text-green-500 font-bold md:pb-5 my-5'>
                ...
                <div className='flex flex-col text-7xl font-bluu sm:text-9xl ml:text-9.5xl  mx-auto lg:hidden'>
                ...
                <div className='lg:flex flex-col text-7xl font-bluu lg:text-10xl  xl:text-12xl  mx-auto hidden'>
